...
<section class="navbar navbar-fixed-top custom-navbar" role="navigation">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a href="#home" class="smoothScroll navbar-brand">FISH.io</a>
		</div>
...
<div id="home">
	<div class="site-slider">
        <ul class="bxslider">
			<li>
                <img src="images/slider/lake-kariba.jpg" alt="slider image 1">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="slider-caption">
                                <h2>SMART WEATHER ALERTS</h2>
                                <p class="color-white">Take part in conserving fish  #fishackathon</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <li>
                <img src="images/slider/img2.jpg" alt="slider image 2">
                <div class="container caption-wrapper">
                    <div class="slider-caption">
                        <h2>BE SMART, BE FISH.IO</h2>
            ...
            <li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="slider-caption">
                                <h2>BE FISH FRIENDLY, BE FISH.IO</h2>
		...
		<div class="row">
			...
			<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8">
				<div class="section-title">
					<h5 class="wow bounceIn">FISH.io</h5>
					<h1 class="heading">WHAT WE DO</h1>
					<hr>
					<p>We create awareness on conservative fishing and smart weather detection to locals in there native languages</p>
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				...
				<h2 class="wow bounceIn">FISH.io</h2>
				<ul class="social-icon">
					<li><a href="#" class="fa fa-facebook wow fadeIn" data-wow-delay="0.3s"></a></li>
					<li><a href="#" class="fa fa-twitter wow fadeIn" data-wow-delay="0.6s"></a></li>
				...
				<p>Copyright &copy; 2016 FISH.io</p>
			</div>
		</div>
	</div>
</footer>
